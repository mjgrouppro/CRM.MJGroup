...
*
*/
define('APP_BASE_URL', 'https://crm.mjgroup.pro/');
...
*/
define('APP_ENC_KEY', '32150cf0de0b350148f842e203f3d8b8');
 ...
 */
define('APP_DB_USERNAME', 'kynguyenx_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '&^$&#$ET&@#%@*#$&');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'kynguyenx_crm');
